    ...
    <Box className="section_words">
      <Grid container spacing={2}>
        <Grid item xs={12} md={5}>
         <img src={wordsimg} className="img-fluid" alt='Words' />
        </Grid>
        <Grid item xs={12} md={7}>
          <Typography variant="body1" className="wordfquote"><img src={fquote} alt='Fquote'/></Typography>
          ...
          <Typography variant="body1" className="wordsquote"><img src={squote} alt='Squote'/></Typography>
